...
#include <stddef.h>
#include "realsense_msgs/msg/detail/imu_info__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  realsense_msgs__msg__IMUInfo__init(message_memory);
}

void IMUInfo__rosidl_typesupport_introspection_c__IMUInfo_fini_function(void * message_memory)
{
  realsense_msgs__msg__IMUInfo__fini(message_memory);
}
