...
#ifndef REALSENSE_MSGS__MSG__DETAIL__IMU_INFO__FUNCTIONS_H_
#define REALSENSE_MSGS__MSG__DETAIL__IMU_INFO__FUNCTIONS_H_
...
#endif  // REALSENSE_MSGS__MSG__DETAIL__IMU_INFO__FUNCTIONS_H_
